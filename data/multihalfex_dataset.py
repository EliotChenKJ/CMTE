...
class MultihalfexDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        """
        train_index = index % self.image_size
        if self.opt.isTrain:
            ...
            path_Ref = self.image_paths[train_index]
            data_Ref = Image.open(path_Ref).convert('RGB')
            path_A = self.image_paths[train_index]
            data_A = Image.open(path_A).convert('RGB')
            path_B = self.image_paths[train_index]
