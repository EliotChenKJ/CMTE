...
def define_D(input_nc, ndf, netD, n_layers_D=3, n_pic=3, norm='batch', init_type='normal', init_gain=0.02, gpu_ids=[]):
...
class MultiNLayerDiscriminator(nn.Module):
    """Defines a PatchGAN discriminator"""
    def __init__(self, input_nc, ndf=64, n_layers=3, n_pic=3, norm_layer=nn.BatchNorm2d):
        """Construct a PatchGAN discriminator
